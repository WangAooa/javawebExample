...
<ul class="cl-vnavigation">
    ...
    <%--<li><a href="#"><i class="fa fa-envelope"></i><span>设备记录管理</span></a>--%>
        <%--<ul class="sub-menu">--%>
            <%--<li <c:if test="${module =='gr_list'}">class="active"</c:if>><a href="${pageContext.request.contextPath }/gr/findByThing.do">GPS记录列表</a></li>--%>
            <%--<li <c:if test="${module =='gr_find'}">class="active"</c:if>><a href="${pageContext.request.contextPath }/gr/toFindByTime.do">GPS记录查询</a></li>--%>
            <%--<li <c:if test="${module =='ar_list'}">class="active"</c:if>><a href="${pageContext.request.contextPath }/ar/findByThing.do">报警记录列表</a></li>--%>
            <%--<li <c:if test="${module =='ar_find'}">class="active"</c:if>><a href="${pageContext.request.contextPath }/ar/toFindByTime.do">报警记录查询</a></li>--%>
            <%--<li <c:if test="${module =='hbr_list'}">class="active"</c:if>><a href="${pageContext.request.contextPath }/hbr/findByThing.do">心跳记录列表</a></li>--%>
            <%--<li <c:if test="${module =='hbr_find'}">class="active"</c:if>><a href="${pageContext.request.contextPath }/hbr/toFindByTime.do">心跳记录查询</a></li>--%>
        <%--</ul>--%>
    <%--</li>--%>
</ul>
</body>
