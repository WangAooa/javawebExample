...
public class C3P0Util {
    ...
    public static void initDataSource() {
        ...
        cpds.setJdbcUrl("jdbc:mysql://localhost:3306/fantainb?serverTimezone=Asia/Shanghai&amp;autoReconnect=true&amp;autoReconnectForPools=true&amp");
        try {
